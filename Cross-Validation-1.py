...
x_train = p.DataFrame(MinMaxScaler().fit_transform(train_set,),columns=headers)
x_test = p.DataFrame(MinMaxScaler().fit_transform(test_set),columns=headers)
features_dict = {}
...
#neural network mlp classifier 
    ...
    clf = MLPClassifier(solver="lbfgs", activation="tanh", alpha=1, batch_size='auto',
...
finalscore_analysis.to_csv("C:/Users/YASH/Documents/Cross Validation-2.csv")
